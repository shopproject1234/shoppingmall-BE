...
public class OrderScaleTest {
    ...
    @DisplayName("상품을 구매 시 해당 상품에 맞는 카테고리의 관심도(scale)를 10 증가시킨다")
    @Test
    void test() {
        //given
        ...
        assertThat(interests.get(0).getScale()).isEqualTo(15); //장바구니 추가(5) + 구매(10) = 15
    }
}
